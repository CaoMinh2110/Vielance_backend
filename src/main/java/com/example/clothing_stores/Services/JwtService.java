...
public class JwtService {
    ...
    public String generateToken(AppUser user){
        ...
        JWTClaimsSet jwtClaimsSet = new JWTClaimsSet.Builder()
                ...
                .expirationTime(new Date(now + VALID_DURATION))
    ...
    public SignedJWT vetifyToken (String token, boolean isRefresh) throws JOSEException, ParseException {
    ...
    public String refreshToken (String token) throws JOSEException, ParseException {
        var signedJWT = vetifyToken(token, true);
